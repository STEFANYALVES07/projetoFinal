...
export default function Copo() {
  ...
  const Tigela = [
    { key: 1, Tamanho: "Copo 300ml", valor: 14.0 },
    { key: 2, Tamanho: "Copo 500ml", valor: 18.0 },
    { key: 3, Tamanho: "Copo 770ml", valor: 22.0 },
  ];
  ...
  return (
    <View style={styles.container2}>
      ...
      <Text style={styles.title}>Escolha o tamanho do seu copo</Text>
      <Picker
